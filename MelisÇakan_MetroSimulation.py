...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        # Kuyruk yapısı ve ziyaret edilen istasyonlar
        kuyruk = deque([(baslangic, [baslangic], None)])  # (istasyon, rota, mevcut_hat)
        ziyaret_edildi = {baslangic}  # Başlangıç istasyonu ziyaret edilmiş olarak işaretlenir
        ...
        while kuyruk:
            ...
            for komsu, sure in istasyon.komsular:
                ...
                if komsu not in ziyaret_edildi:
                    # Hat değişimi varsa, aktarma sayısını artırmak için mevcut_hat kontrolü
                    yeni_hat = komsu.hat if komsu.hat != mevcut_hat else mevcut_hat
                    yeni_rota = rota + [komsu]
                    kuyruk.append((komsu, yeni_rota, yeni_hat))
                    ziyaret_edildi.add(komsu)  # Komşu istasyonu ziyaret edilmiş olarak işaretle
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        # A* algoritması için öncelik kuyruğu (priority queue)
        ...
        while pq:
            ...
            # Hedef istasyon bulunduğunda rota ve süre döndürülür
            if istasyon == hedef:
